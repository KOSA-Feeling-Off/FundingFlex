...
public interface PayMapper {
	...
	public PayCancelDTO getFundingIdAndFundingAmountByJoinId(@Param("fundingJoinId") Long fundingJoinId);
	...
	void updateFundingConditionsCollectedAmount(@Param("fundingsId") Long id, @Param("amount") Long amount);
	public Long getPercentByFundingsId(@Param("fundingsId") Long fundingsId);
}
